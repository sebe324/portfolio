...
const projects=[
    ...
    },
    {
        ...
        projectUrl:"https://github.com/sebe324/Various-Visualization",
        tools:["Qt","C++","CMake"]
    },
    {
        src:image4,
        ...
        tools:["React","Bootstrap","Node.js","JavaScript"]
    }
]
function Home() {
    ...
    return(
        <main>
            <div className='container-fluid'>
                <div className='row front-look justify-content-md-center'>
